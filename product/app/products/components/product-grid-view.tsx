...
export const ProductGridView = ({ products }: { products: ProductDto[] }) => {
            ...
            >
              ...
              >
                {product.showDiscountPercentage === "Show" && (
                  <div className="absolute top-2 left-2 text-white px-1 py-1 rounded-full text-sm font-medium z-10">
                    <PulsatingButton
                      pulseColor="red"
                      className="bg-red-500 font-bold flex !px-0"
                    >
                      <span className="flex">
                ...
                <div className="relative h-48 mb-4 rounded-lg overflow-hidden group-hover:scale-110 cursor-pointer">
                  <Image
                    src={
